...
public class EventApi {
	...
	public EventAPI() {
		...
		Event e2 = new Event(2, "WKS002", "All-Java Conference", "Hands-on Spring Boot Workshop");
		Event e3 = new Event(3, "TRN001", "All-Java Conference", "Five day introductory training in Angular");
